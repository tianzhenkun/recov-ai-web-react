...
} from '@/modules/recov/services/instrument';
import {
  listSeal,
  type SealCode,
  type SealVO,
} from '@/modules/recov/services/seal';
import {
  matchStanding,
  type StandingMatchItem,
  type StandingMatchVO,
} from '@/modules/recov/services/standing';
import { downloadOss, listOssByIds } from '@/shared/services/oss';
...
import { buildInstrumentPreviewDocument } from './previewSecurity';
import './index.css';
...
const renderPreviewHtml = (html: string) =>
  buildInstrumentPreviewDocument(html);
