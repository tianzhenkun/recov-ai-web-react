...
} from '@/modules/recov/pages/instrument/components/DocumentPreviewWorkspace';
import type {
...
const LitigationFilingMaterialsDrawer = ({
  ...
  const selectedDocumentPublicUrl = normalizeSafeResourceUrl(
                ...
                <>
                  ...
                  >
                    ...
                    <Space size={4} wrap={false}>
                      <Button
                        href={selectedDocumentPublicUrl}
                        target="_blank"
