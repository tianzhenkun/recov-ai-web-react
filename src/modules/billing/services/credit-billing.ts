...
export type CreditPackagePaymentStatus =
  ...
  | 'EXPIRED'
  | 'REFUNDED';
export type CreditPackageRefundStatus = 'PROCESSING' | 'SUCCEEDED' | 'FAILED';
...
export const listCreditProducts = async (params?: {
  ...
  unwrapList(
    await ruoyiRequest<CreditProduct[]>(
      `${CREDIT_ADMIN_BASE}/catalog/products`,
      {
        method: 'get',
        params,
      },
...
export const saveCreditMeterScenario = async (
  ...
  unwrapData(
    await ruoyiRequest<CreditMeterScenario>(
      `${CREDIT_ADMIN_BASE}/catalog/meter-scenarios`,
      {
        method: 'put',
        data,
        repeatSubmit: false,
...
export const createCreditPackage = async (data: CreditPackageCreatePayload) =>
  unwrapData(
...
export const updateCreditPackageStatus = async (
  ...
  unwrapData(
    await ruoyiRequest<CreditPackage>(
      `${CREDIT_ADMIN_BASE}/packages/${id}/status`,
      {
        method: 'put',
        data,
        repeatSubmit: false,
...
export const saveCreditCouponTemplate = async (
  ...
  unwrapData(
    await ruoyiRequest<CreditCouponTemplate>(
      `${CREDIT_ADMIN_BASE}/coupon-templates`,
      {
        method: 'put',
        data,
        repeatSubmit: false,
...
export const saveCreditPricingRule = async (
  ...
  unwrapData(
    await ruoyiRequest<CreditPricingRule>(
      `${CREDIT_ADMIN_BASE}/catalog/pricing-rules`,
      {
        method: 'put',
        data,
        repeatSubmit: false,
...
export const pageCreditOrders = async (params?: {
  ...
  unwrapPage(
    await ruoyiRequest<CreditChargeOrder>(
      `${CREDIT_ADMIN_BASE}/charge-orders`,
      {
        method: 'get',
        params,
      },
...
export const grantAdminCredit = async (data: AdminCreditGrantPayload) =>
  unwrapData(
...
export const getScopedCreditEntitlements = async (scope: 'tenant' | 'me') =>
  unwrapData(
